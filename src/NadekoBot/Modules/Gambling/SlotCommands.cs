                ...
                try
                {
                    ...
                    using (var bgFileStream = _images.SlotBackground.ToStream())
                    {
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            {
                                bgImage.DrawImage(randomImage, 100, default(Size), new Point(95 + 142 * i, 447));
                            }
                        }
                        ...
                        do
                        {
                            ...
                            {
                                bgImage.DrawImage(img, 100, default(Size), new Point(230 - n * 16, 558));
                            }
                            n++;
                        } while ((printWon /= 10) != 0);
                        ...
                        do
                        {
                            ...
                            using (var img = ImageSharp.Image.Load(fs))
                            {
                                bgImage.DrawImage(img, 100, default(Size), new Point(395 - n * 16, 588));
                            }
                            n++;
